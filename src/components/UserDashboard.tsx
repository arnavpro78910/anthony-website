...
export const UserDashboard: React.FC<UserDashboardProps> = ({
  ...
  // This shows exactly once per login session to avoid popping up on minimize/re-open or re-renders
  useEffect(() => {
    // We only check this once when the component mounts (right after login)
